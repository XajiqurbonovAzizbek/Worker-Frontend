...
export default function Search() {
  ...
  return (
    <div
      className="col position-relative p-2 px-3 card rounded-5 shadow-lg"
      style={{ width: "35%" }}
    >
      <div
      ...
      {isSearch ? (
        <>
          ...
          >
            <ul
              className={`${style.scrollList} h-100`}
            ...
            {islistItem && (
              <div
                className="w-100 mh-100 position-absolute card pt-2 rounded-4 shadow-lg border-0"
                style={{
                  top: 0,
                  left: "100%",
